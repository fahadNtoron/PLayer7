import logos from "../assets/myAssets/logo-footer.png";

const Footer = () => {
  return (
    <div className="bg-gray-700 flex flex-col justify-center items-center pt-36">
      <img src={logos} alt="" />
      <footer className="footer bg-gray-700 text-base-content p-10">
        <aside>
          <svg
            width="50"
            height="50"
      ...
      <p>@2024 tORON All Rights Reversed.</p>
    </div>
  );
};
